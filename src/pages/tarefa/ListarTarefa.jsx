...
const ListarTarefa = () => {
  ...
  return (
    ...
    >
      <Card style={{ backgroundColor: '#1e1e1e', color: '#e0e0e0' }}>
        <CardHeader
          title="Tarefas"
        ...
        />
        <CardContent>
          <TableContainer component={Paper} style={{ backgroundColor: '#2c2c2c', color: '#e0e0e0' }}>
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
              <TableHead>
                <TableRow>
                  <TableCell style={{ color: '#f8f8f8' }}>#</TableCell>
                  <TableCell style={{ color: '#f8f8f8' }}>Título</TableCell>
                  <TableCell style={{ color: '#f8f8f8' }} align="right">Descrição</TableCell>
                  <TableCell style={{ color: '#f8f8f8' }} align="right">Data de Início</TableCell>
                  <TableCell style={{ color: '#f8f8f8' }} align="right">Data de Finalização</TableCell>
                  <TableCell style={{ color: '#f8f8f8' }} align="right">Status</TableCell>
                  <TableCell style={{ color: '#f8f8f8' }} align="right">Recurso</TableCell>
                  <TableCell style={{ color: '#f8f8f8' }} align="left"></TableCell>
                  <TableCell style={{ color: '#f8f8f8' }} align="left"></TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                {tarefas.map((row, indice) => (
                  ...
                  >
                    <TableCell style={{ color: '#f8f8f8' }} component="th" scope="row">
                      {row.idTarefa}
                    </TableCell>
                    <TableCell style={{ color: '#f8f8f8' }} component="th" scope="row">
                      {row.tituloTarefa}
                    </TableCell>
                    <TableCell style={{ color: '#f8f8f8' }} align="right">{row.descricaoTarefa}</TableCell>
                    <TableCell style={{ color: '#f8f8f8' }} align="right">{row.inicioTarefa}</TableCell>
                    <TableCell style={{ color: '#f8f8f8' }} align="right">{row.fimTarefa}</TableCell>
                    <TableCell style={{ color: '#f8f8f8' }} align="right">{row.statusTarefa}</TableCell>
                    <TableCell style={{ color: '#f8f8f8' }} align="right">{row.recursoTarefa}</TableCell>
                    <TableCell style={{ color: '#f8f8f8' }} align="center">
